...
installation, service, or data paths. The topology selects this adapter with
`vagrant_fixture: mixed-rke2`; another distribution can provide a sibling
fixture without changing `LibvirtProvider`.
